        ...
        <>
          ...
          <form className={styles.formContainer} onSubmit={handleSubmit}>
            <div className={styles.formGroup}>
              ...
              />
              {errors.name && (
                <p className={styles.error}>El nombre es obligatorio</p>
              )}
            </div>
            <div className={styles.formGroup}>
              ...
              />
              {errors.lastname && (
                <p className={styles.error}>El apellido es obligatorio</p>
              )}
            </div>
            <div className={styles.formGroup}>
              ...
              />
              {errors.address && (
                <p className={styles.error}>La direccion es obligatoria</p>
              )}
            </div>
            <div className={styles.formGroup}>
              ...
              />
              {errors.email && (
                <p className={styles.error}>El correo es obligatorio</p>
              )}
            </div>
            <div className={styles.formGroup}>
              ...
              />
              {errors.phone && (
                <p className={styles.error}>El telefono es obligatorio</p>
              )}
            </div>
